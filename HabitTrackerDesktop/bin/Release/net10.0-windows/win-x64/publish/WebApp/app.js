...
const DAILY_QUOTES = [
  {
    quote: "Nem számít, milyen lassan haladsz, amíg nem állsz meg.",
    author: "Konfuciusz"
  },
  {
    quote: "Higgy benne, hogy képes vagy rá, és már félig meg is érkeztél.",
    author: "Theodore Roosevelt"
  },
  {
    quote: "A nagyszerű munka egyetlen útja az, ha szereted, amit csinálsz.",
    author: "Steve Jobs"
  },
  {
    quote: "A cselekvés megszünteti a kételyt.",
    author: "Nashid Sharrief"
  },
  {
    quote: "Ha elfáradsz, tanulj meg pihenni, ne feladni.",
    author: "Banksy"
  },
  {
    quote: "Nem kell látnod az egész lépcsőt, csak tedd meg az első lépést.",
    author: "Martin Luther King"
  },
  {
    quote: "Minden, amire valaha vágytál, a félelmen túl vár rád.",
    author: "George Addair"
  },
  {
    quote: "A siker nem végleges, a kudarc nem végzetes: a folytatáshoz szükséges bátorság az, ami igazán számít.",
    author: "Winston Churchill"
  },
  {
    quote: "Tedd meg, amit tudsz, azzal amid van, ott ahol vagy.",
    author: "Theodore Roosevelt"
  },
  {
    quote: "Tedd minden napodat a saját mesterműveddé.",
    author: "John Wooden"
  },
  {
    quote: "A jövő attól függ, mit teszel ma.",
    author: "Mahatma Gandhi"
  },
  {
    quote: "A szokásaid alakítják a jövődet, jóval azelőtt, hogy észrevennéd.",
    author: "Ismeretlen"
  },
  {
    quote: "A fegyelem az a híd, ami összeköti a célokat az eredményekkel.",
    author: "Jim Rohn"
  },
  {
    quote: "Ne várj a tökéletes pillanatra, ragadd meg ezt a pillanatot, és tedd tökéletessé.",
    author: "Zoey Sayward"
  },
  {
    quote: "A siker az apró erőfeszítések összege, amelyeket nap mint nap megismételsz.",
    author: "Robert Collier"
  },
  {
    quote: "A kitartás nem hosszú verseny, hanem sok rövid verseny egymás után.",
    author: "Walter Elliot"
  },
  {
    quote: "Légy erősebb a kifogásaidnál.",
    author: "Ismeretlen"
  },
  {
    quote: "A kezdet mindig nehezebb, mint a folytatás.",
    author: "Ismeretlen"
  },
  {
    quote: "Nem az motiváció tart életben, hanem a rendszer, amit felépítesz.",
    author: "Ismeretlen"
  },
  {
    quote: "Minden szakértő valaha kezdő volt.",
    author: "Helen Hayes"
  },
  {
    quote: "A következetesség többet ér, mint az alkalmi lelkesedés.",
    author: "Ismeretlen"
  },
  {
    quote: "Egy év múlva hálás leszel magadnak azért, hogy ma nem adtad fel.",
    author: "Ismeretlen"
  },
  {
    quote: "A célokhoz vezető út a napi döntéseidben rejlik.",
    author: "Ismeretlen"
  },
  {
    quote: "Nem kell jobbnak lenned mindenkinél, csak jobbnak, mint tegnap voltál.",
    author: "Ismeretlen"
  }
];
...
function handleCreateCalendarEvent(event) {
  ...
  if (!name || !startDate || !endDate) {
    setStatusMessage(calendarStatus, "Az esemény neve és dátuma kötelező.", "error");
    return;
  }

  if (endDate < startDate) {
    setStatusMessage(calendarStatus, "A zárónap nem lehet korábbi a kezdőnapnál.", "error");
    return;
  }

  if (!allDay && startTime && endTime && endTime <= startTime && startDate === endDate) {
    setStatusMessage(calendarStatus, "Az aznapi befejezés legyen későbbi a kezdésnél.", "error");
    return;
  }
  ...
  syncCalendarEventTimeInputs();
  renderCalendar();
  setStatusMessage(calendarStatus, "Az esemény mentése sikerült.", "success");
}
...
function openCalendarEventModal(eventId) {
  ...
  calendarEventModalSource.textContent = event.source === "import" ? "Importált naptár" : "Kézzel rögzített";
  calendarEventModalNotes.textContent = event.notes || "Nincs megjegyzés.";
...
function handleDeleteCalendarEvent() {
  ...
  closeCalendarEventModal();
  renderCalendar();
  setStatusMessage(calendarStatus, "Az esemény törlése sikerült.", "success");
}
...
function formatEventDuration(event) {
  if (event.allDay) {
    return event.startDate === event.endDate ? "Egész napos" : "Többnapos, egész napos";
  }
